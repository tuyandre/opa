                ...
                <div class="portfolio-details-slider swiper">
                    <div class="swiper-wrapper align-items-center">
                        ...
                        <div class="swiper-slide">
                            <img src="{{asset(VariableConstants::ROOT_FOLDER.'assets/img/web_0.jpg')}}" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{asset(VariableConstants::ROOT_FOLDER.'assets/img/web_1.jpg')}}" alt="">
                        </div>

                        <div class="swiper-slide">
                            <img src="{{asset(VariableConstants::ROOT_FOLDER.'assets/img/web_2.jpg')}}" alt="">
                        </div>
