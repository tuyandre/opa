...
{{--                    <h3>Opa</h3>--}}
                    <p>
                        Ziniya, Near World Food Program  <br>
                        Kicukiro, Kigali<br>
                        Rwanda <br><br>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Our Services</h4>
                    <ul>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Tax Consultancy Services</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Business Consulting Services</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Audit Services</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Training Services</a></li>
                        <li><i class="bx bx-chevron-right"></i> <a href="#">Accounting Software Installation</a></li>
                    </ul>
                </div>
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    ...
                    <p class="">At OPA, we understand the power and importance of social media in today's digital landscape.
                        We actively engage with our audience across various social media platforms, including Facebook, Twitter, Instagram,
                        LinkedIn, and more.
    ...
    <div class="container footer-bottom clearfix">
        ...
        <div class="credits">
            ...
            Designed by <a href="https://www.linkedin.com/in/tuyizere-andre-0725b6160/" target="_blank">Tuyandre</a>
        </div>
    </div>
</footer><!-- End Footer -->
