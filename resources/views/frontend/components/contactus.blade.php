        ...
        <div class="row">
            ...
            <div class="col-lg-5 d-flex align-items-stretch">
                <div class="info">
                    ...
                    <div style="width: 100%"><iframe width="100%" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=300&amp;hl=en&amp;q=Ziniya%20Market+(Office%20of%20Professional%20Auditor)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe></div>
            ...
            <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                ...
                <form action="{{route('frontend.contact-us.store')}}" method="post" id="contactus_form" role="form" class="php-email-form">
                    ...
                    <div class="text-center">
                        <input type="submit" class="btn btn-info" value="Send Message"/></div>
                </form>
            </div>
